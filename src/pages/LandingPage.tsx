    ...
    return (
        <Box>
            ...
            <Box  mr={{base:"1rem", md:"1rem"}} ml={{base:"1rem", md:"1rem"}}>
                ...
                <Text as="h1" fontSize={{base:"2rem",md:"4rem"}} fontWeight="bold" mb={{base:"0.7rem",md:"2rem"}}>Weather <br/>
                Forecast</Text>
                <Link to="/weather">
                <Button bg="#f3f" color="#fff"  padding="1.2rem;" boxShadow="0px 5px 5px rgb(75 93 104 / 10%);" borderRadius="2.5rem" mt={{base:"1.5rem",md:"3rem"}} _hover={{ bg: "#f3f" }}>Discover</Button>
        </Link>
